...
class Technology(Model):
    ...
    content = Column(String(500), nullable=False)
    date = Column(Date, default=datetime.date.today(), nullable=True)
    technologyCat_id = Column(Integer, ForeignKey('technology_category.id'), nullable=False)
    technologyCat = relationship("TechnologyCategory")
...
class Life(Model):
    ...
    content = Column(String(500), nullable=False)
    date = Column(Date, default=datetime.date.today(), nullable=True)
    lifeCat_id = Column(Integer, ForeignKey('life_category.id'), nullable=False)
    lifeCat = relationship("LifeCategory")

class LifeCategory(Model):
    __tablename__ = 'life_category'
    id = Column(Integer, primary_key=True)
    name = Column(String(50), nullable=False)
...
class Interest(Model):
    ...
    content = Column(String(500), nullable=False)
    date = Column(Date, default=datetime.date.today(), nullable=True)
    interestCat_id = Column(Integer, ForeignKey('interest_category.id'), nullable=False)
    interestCat = relationship("InterestCategory")

class InterestCategory(Model):
...
class Other(Model):
    ...
    content = Column(String(500), nullable=False)
    date = Column(Date, default=datetime.date.today(), nullable=True)
    otherCat_id = Column(Integer, ForeignKey('other_category.id'), nullable=False)
    otherCat = relationship("OtherCategory")

class OtherCategory(Model):
    __tablename__ = 'other_category'
    id = Column(Integer, primary_key=True)
    name = Column(String(50), nullable=False)
